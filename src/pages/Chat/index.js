...
export default function Chat() {
  ...
  return (
    <>
      ...
      {/* <!--chat-->  */}
      <section id="projects" class="text-center mt-4 pt-4">
            ...
            <div class="col">
              ...
              >
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">SCID.STORE</h5>
                      <p class="card-text ">Apakah barang ini masih ada ?</p>
                      <p class="card-text">
              ...
              >
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">FAITH.STORE</h5>
                      <p class="card-text">Apakah barang ini masih ada?</p>
                      <p class="card-text">
                        <small class="">Last updated 4 mins ago</small>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">ROZES.STORE</h5>
                      <p class="card-text">Apakah barang ini masih ?</p>
                      <p class="card-text">
              ...
              >
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body">
                      <h5 class="card-title">ANA.STORE</h5>
                      <p class="card-text">Apakah barang ini masih ?</p>
                      <p class="card-text">
                        <small class="">Last updated 6 mins ago</small>
                      </p>
                    </div>
                  </div>
                </div>
